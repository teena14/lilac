...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-white text-[#2f3a1f]">
      ...
      {/* Main Container */}
      <section className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 pt-8 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center items-start">
          
          <div className="flex flex-col items-center">
            <h3 className="font-heading text-xl tracking-widest uppercase text-[#2f3a1f] mb-6 whitespace-nowrap">
              Location
            </h3>
            <p className="text-sm leading-relaxed text-[#2f3a1f]">
              123 Wilshire Boulevard, Suite 400<br />
          ...
          <div className="flex flex-col items-center">
            ...
            <a
              ...
              className="block text-sm text-[#2f3a1f] hover:text-[#2f3a1f] transition-colors mb-2"
            >
              hello@drmaya.com
            </a>
            <a
              href="tel:5555555555"
              className="block text-sm text-[#2f3a1f] hover:text-[#2f3a1f] transition-colors"
            >
              (555) 555-5555
            </a>
          </div>
          ...
          <div className="flex flex-col items-center">
            <h3 className="font-heading text-xl tracking-widest uppercase text-[#2f3a1f] mb-6">
              Before<br/>Reaching Out
            </h3>
            <p className="text-sm leading-relaxed text-[#2f3a1f]">
      ...
      {/* Footer Legal Bar */}
      <div className="border-t border-[#2f3a1f] bg-[#E5E6E1] px-6 md:px-16 py-12 text-center space-y-4 text-base mt-20">
